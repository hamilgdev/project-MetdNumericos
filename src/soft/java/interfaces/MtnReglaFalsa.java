...
import soft.java.clases.FuntionRulerFalsi;


public class MtnReglaFalsa extends javax.swing.JFrame {

    int x, y;
    
    public MtnReglaFalsa() {
        this.setUndecorated(true);
        initComponents();
        setTitle("Método Regla falsa");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MtnReglaFalsa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MtnReglaFalsa().setVisible(true);
            }
        });
    }
